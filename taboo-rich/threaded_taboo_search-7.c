...
void tabu_search_full(){
    ...
    /*
    make a fifo to use as tabu list
    */
    ...
    while(gsize < MAXSIZE){
        ...
        */
        if(count == 0){
            ...
            printf("..-> 1 <-..Eureka! Counter-example found!\n");
            PrintGraph(g, gsize);
            ...
            */
            ...
            /*
            throw away the old graph and make new one graph
            */
            free(g);
            g = new_g;
            gsize++;
        ...
        and unfilp the edge. We'll then remember the best flip and
...
/*
partial version:
assuming the counter example is embeded in 
the graph one size bigger
*/
